...
students = 22
added_students = 2
p students + added_students

# Write code that subracts 2 from the `students` variable and
# prints the result:
dropped_students = 2
p students - dropped_students
...
# is_hungry is a boolean
# number_of_pets is an integer
...
p "My first name could be #{first_name}, do I eat all day long? #{is_hungry} and I have #{number_of_pets} pet."
...
# Did you run this file in your terminal to make sure everything printed out to the terminal (yes)
